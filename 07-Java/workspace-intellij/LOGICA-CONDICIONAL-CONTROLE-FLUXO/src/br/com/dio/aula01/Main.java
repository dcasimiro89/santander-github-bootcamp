...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("int i1 = 10; int i2 = 20;");/* int i1 = 10; int i2 = 20; */
        System.out.println("i1 == i2 " + (i1 == i2));
        System.out.println("i1 != i2 " + (i1 != i2));
        System.out.println("i1 > i2 " + (i1 > i2));
        System.out.println("i1 <= i2 " + (i1 <= i2));

        System.out.println("\nfloat f1 = 4.5f; float f2 = 3.5f;");/* float f1 = 4.5f; float f2 = 3.5f; */
        ...
        System.out.println("\nString s1 = \"Fulano\"; String s2 = \"Fulano\"; String s3 = \"Cicrano\"");
